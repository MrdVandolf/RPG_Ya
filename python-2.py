...
class Person:  # класс персонажа
    ...
    def damage(self, attack):  # функция получения урона
        ...
        if chance_to_evade > self.out_evas:  # если шанс попадания не больше уклонения
...
class UiMainWindow(QWidget):
    ...
    def main_create(self):
        ...
        self.textBrowsers.setGeometry(QtCore.QRect(270, 90, 351, 301))
    ...
    def fight_open(self):
        ...
        self.textBrowsers.setText('Бой начался\n{} на изготовке.\nВаш ход первый.'.format(rival.name))
