...
class UiMainWindow(QWidget):
    ...
    def main_create(self):
        ...
        label_2s.setGeometry(QtCore.QRect(70, 60, 121, 16))
        ...
        label_4s.setGeometry(QtCore.QRect(60, 260, 91, 16))
        label_4s.setObjectName("label_4")
        label_5s = QLabel(self)
        label_5s.setGeometry(QtCore.QRect(60, 160, 71, 16))
        ...
        label_7s.setGeometry(QtCore.QRect(750, 60, 121, 16))
        ...
        label_13s.setGeometry(QtCore.QRect(60, 220, 71, 16))
        label_13s.setObjectName("label_13")
        label_8s = QLabel(self)
        label_8s.setGeometry(QtCore.QRect(760, 160, 71, 16))
        ...
        label_14s.setGeometry(QtCore.QRect(760, 220, 121, 16))
        ...
        label_11s.setGeometry(QtCore.QRect(760, 260, 91, 16))
        ...
        label_17s = QLabel(self)
        label_17s.setGeometry(QtCore.QRect(80, 20, 55, 16))
        label_17s.setObjectName("label_17")
        ...
        label_17s.setText(_translate("Form", "Ловкач"))

        self.fight_list = [label_2s, label_3s, label_4s, label_5s, label_6s, textBrowsers, label_7s, label_8s,
                           label_9s, label_10s, label_11s, label_12s, label_13s, label_14s, label_15s, progressBar_2s,
                           progressBars, pushButton_2s, pushButtons, pushButton_7s, label_17s, label_16s]
