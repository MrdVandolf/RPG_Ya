...
class Person:  # класс персонажа
    ...
    def print_info(self):  # функция, выводящая всю инфу по персонажу
        ...
        self.win[2].setText('Защита: {}'.format(self.protection))
        self.win[3].setText('Увертливость: {}'.format(self.evasion))
...
class UiMainWindow(QWidget):
    ...
    def __init__(self, hero):
        ...
        self.Rivals = [Person('Шарль Убийца', 80, 15, 35, 40),
                       Person('Харальд', 140, 35, 50, 0),
                       Person("Ураг гро-Шуб", 120, 25, 60, 30),
                       Person('Малакат', 90, 10, 70, 40)]
    ...
    def main_create(self):
        ...
        label.setGeometry(QtCore.QRect(10, 490, 151, 131))
        ...
        textBrowsers.setGeometry(QtCore.QRect(270, 90, 351, 301))
        ...
        self.enemy_evasion.setGeometry(QtCore.QRect(60, 260, 91, 16))
        self.enemy_evasion.setObjectName("self.enemy_evasion")
        
        self.enemy_protect = QLabel(self)
        self.enemy_protect.setGeometry(QtCore.QRect(60, 160, 71, 16))
        ...
        self.enemy_damage.setGeometry(QtCore.QRect(60, 220, 71, 16))
        self.enemy_damage.setObjectName("self.enemy_damage")
        
        self.player_protect = QLabel(self)
        self.player_protect.setGeometry(QtCore.QRect(760, 160, 71, 16))
        ...
        self.player_damage.setGeometry(QtCore.QRect(760, 220, 121, 16))
        ...
        self.player_evasion.setGeometry(QtCore.QRect(760, 260, 91, 16))
        ...
        pushButtons = QPushButton(self)
        pushButtons.setGeometry(QtCore.QRect(270, 390, 171, 51))
        pushButtons.setObjectName("pushButton")
        
        pushButton_2s = QPushButton(self)
        pushButton_2s.setGeometry(QtCore.QRect(450, 390, 171, 51))
        pushButton_2s.setObjectName("pushButton_2")
        
        pushButton_7s = QPushButton(self)
        pushButton_7s.setGeometry(QtCore.QRect(350, 20, 201, 51))
        pushButton_7s.setStyleSheet("background: rgb(34, 168, 19)\n")
        pushButton_7s.setObjectName("pushButton_7")
        pushButton_7s.pressed.connect(self.main_open)
        ...
        self.enemy_name.setGeometry(QtCore.QRect(80, 20, 75, 16))
        ...
        pushButtons.setText(_translate("Form", "Атаковать"))
        pushButton_2s.setText(_translate("Form", "Защищаться"))
        pushButton_7s.setText(_translate("Form", "Покинуть бой"))
        ...
        self.fight_list = [self.enemy_hp, label_3s, self.enemy_evasion, self.enemy_protect,
                           label_6s, textBrowsers, self.player_hp, self.player_protect, label_9s,
                           label_10s, self.player_evasion, label_12s, self.enemy_damage,
                           self.player_damage, label_15s, progressBar_2s, progressBars,
                           pushButton_2s, pushButtons,
                           pushButton_7s, self.enemy_name, label_16s]
    ...
    def fight_open(self):
        ...
        rival = self.RIVALS[a]
        rival.set_win(self.enemy_fight)
        rival.print_info()
        self.player.set_rival(rival)
        self.enemy_name.setText(rival.name)
