...
class UiMainWindow(QWidget):
    ...
    def main_create(self):
        ...
        label_5.setText(_translate("MainWindow", "<html><head/><body><p>"
                                                 "<img src=\"magomed.jpg\"/></p></body></html>"))
        label_2.setText(_translate("MainWindow", "<html><head/><body><p><img src=\"ork.jpg\"/></p></body></html>"))
        ...
        label_312.setText(_translate("Form", "<html><head/><body><p><img src=\"lovkost.jpg\"/></p></body></html>"))
        label_313.setText(_translate("Form", "<html><head/><body><p><img src=\"berserk.jpg\"/></p></body></html>"))
        label_314.setText(_translate("Form", "<html><head/><body><p><img src=\"poition1.jpg\"/></p></body></html>"))

        label_216.setText(_translate("Form", "<html><head/><body><p><img src=\"sword.jpg\"/></p></body></html>"))
        ...
        label_214.setText(_translate("Form", "<html><head/><body><p><img src=\"armor.jpg\"/></p></body></html>"))
...
Бой начался\nВаш ход первый.\n'''.format(self.rival.name))
    ...
    def attack(self):
        if self.turn == 'player':
            ...
            if self.rival.health == 0:
                ...
                if self.rival == self.Rivals[-1]:
                    self.dialog_window = Dialog(self.rival.money, self.main_open,
                                                'champion', self.escape)
                else:
                    self.dialog_window = Dialog(self.rival.money, self.main_open,
                                                'winner', self.escape)
    ...
    def enemy_turn(self):
        ...
        if self.player.health == 0:
            ...
            self.attack_button.hide()
            self.defend_button.hide()
            self.dialog_window = Dialog(0, self.main_open, 'loser', self.escape)
            self.dialog_window.show()
        else:
            if self.action_points < 1:
                self.action_points = 2
