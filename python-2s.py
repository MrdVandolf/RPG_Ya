...
class UiMainWindow(QWidget):
    ...
    def __init__(self, hero):
        ...
        self.Items = [Weapon('Меч', 25, 30), Weapon('Боевой топор', 35, 50),
                      Weapon('Боевой молот', 60, 300), Armor('Кираса', 15, 0, 20),
                      Armor('Кольчуга', 45, -30, 80), Armor('Латы', 75, -60, 350),
                      Potion('evasion', 20, 30), Potion('damage', 15, 80),
                      Potion('protect', 15, 100)]
        ...
        self.Rivals = [Person('Шарль Убийца', 80, 5, 40, 50, 40),
                       Person('Харальд', 170, 25, 50, 0, 90),
                       Person("Ураг гро-Шуб", 170, 50, 70, 30, 120),
                       Person('Малакат', 100, 5, 100, 85, 5000)]
    ...
    def attack(self):
        if self.turn == 'player':
            ...
            if self.rival.health == 0:
                ...
                self.dialog_window = Dialog(self.rival.money)
